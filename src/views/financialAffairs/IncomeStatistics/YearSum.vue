            ...
            <div class="FA-warpper">
                <el-form :model="SumTop" label-width="100px" ref="renewForm" class="clear sumTop">
                    <el-form-item label="统计年份">
                        ...
                        <el-button type="primary" @click.native="getTableList()" >查询</el-button>
                        <!-- <el-button type="primary" @click.native="find" >导入</el-button> -->
                        <el-button type="primary" @click.native="exportChardeDataYear()" >导出</el-button>
                    </el-form-item>
                </el-form>
                ...
                <el-table :data="array" :header-cell-style="{'text-align':'center'}" v-if="this.SumTop.sumState=='0'" show-summary highlight-current-row v-loading="listLoading"  style="width: 100%;margin-bottom:10px">
                    <el-table-column prop="dateStr" label="月份" width="55" align="center">
                    </el-table-column> 
                ...
                <el-button type="primary" style="padding:5px">GO</el-button> -->
                <!--<div class="elPag ">-->
                    <!--<el-pagination-->
                        <!--@size-change="handleSizeChange"-->
                        <!--@current-change="handleCurrentChange"-->
...
<!--<script src="@/assets/js/financialAffairs/IncomeStatistics/yearSum.js"></script>-->
<script>

    // 引入基本模板
    let echarts = require('echarts/lib/echarts');

    import { getChargeCountYear,exportChardeDataYear } from '@/api/api';
